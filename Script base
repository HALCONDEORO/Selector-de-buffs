...
(function (func) {
    ...
    BUSCADOR = {
        ...
        updateUrl: 'https://greasyfork.org/es//scripts/6314-the-west-selector-de-buffs/code/The%20West%20-%20Selector%20de%20Buffs.user.js',
        buff: [],
        langs: {
            en: {
                language: 'English',
...
//Mover trabajos a la izq para que entren todos los scripts
